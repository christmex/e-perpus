...
class ProductCategoryCrudController extends CrudController
{
    ...
    {
        CRUD::column('product_category_name');
        CRUD::addColumn(
            [
                'label'     => 'Parent', // Table column heading
                'type'      => 'select',
                'name'      => 'product_category_parent_id', // the column that contains the ID of that connected entity;
                'entity'    => 'parent', // the method that defines the relationship in your Model
                'attribute' => 'product_category_name', // foreign key attribute that is shown to user
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('product_category_name');
        CRUD::addField(
            [  // Select
                'label'     => "ProductCategory",
                'type'      => 'select',
                'name'      => 'product_category_parent_id', // the db column for the foreign key
                'entity'    => 'ProductCategory',
             
                // optional - manually specify the related model and attribute
                'model'     => "App\Models\ProductCategory", // related model
                'attribute' => 'product_category_name', // foreign key attribute that is shown to user
